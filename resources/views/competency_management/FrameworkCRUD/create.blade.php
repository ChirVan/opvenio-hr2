        ...
        <div class="mx-auto px-4">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900">Create New Framework</h1>
                        <p class="text-gray-600 mt-1">Add a new competency framework to your system</p>
                    </div>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <form action="{{ route('competency.frameworks.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="px-6 py-4 border-b border-gray-200 bg-green-50">
                        <h3 class="text-lg font-medium text-green-800">Framework Information</h3>
                    </div>
