        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-900">Add Training Catalog Entry</h2>
                ...
                <!-- Add Training Catalog Form -->
                <form action="{{ route('training.catalog.store') }}" method="POST" class="space-y-6">
                    @csrf
                                ...
                                <select name="title" required
                                    ...
                                    @foreach($frameworks as $framework)
                                        @if($framework->status === 'active')
                                            <option value="{{ $framework->framework_name }}" {{ old('title') == $framework->framework_name ? 'selected' : '' }}>
