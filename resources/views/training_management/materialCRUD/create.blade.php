<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <nav class="flex mb-6" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                <i class='bx bx-chevron-right text-gray-400'></i>
                                <span class="ml-1 text-gray-900 font-medium">Create Material</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Create Training Material</h1>
                        <p class="text-gray-600 mt-2">Create engaging lesson content for <strong>{{ $catalog->title }}</strong></p>
                    </div>
                    <a href="{{ route('training.catalog.detail', $catalog) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md inline-flex items-center">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('training.materials.store', $catalog) }}" class="space-y-8">
                    @csrf
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select id="competency_id" name="competency_id" 
                                    ...
                                    @foreach($competencies as $competency)
                                        <option value="{{ $competency->id }}" data-levels="{{ $competency->proficiency_levels }}" {{ old('competency_id') == $competency->id ? 'selected' : '' }}>
                    ...
                    <div class="bg-blue-50 rounded-lg p-6">
                        ...
                        <p class="text-gray-600 mb-6">Create your lesson content with rich text formatting and images</p>
                        ...
                        <div class="relative">
                            <div id="lesson-editor" 
                                 ...
                                 data-placeholder="Start writing your lesson content here... You can format text, add images, and create lists.">{!! old('lesson_content') !!}</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const oldProficiencyLevel = "{{ old('proficiency_level') }}";
            ...
            // Initialize proficiency levels if competency is already selected (from old values)
            ...
            document.getElementById('save-draft').addEventListener('click', function() {
                // Update content before saving draft
                updateContent();
                
                // Change form action to draft route
                const originalAction = form.action;
                form.action = "{{ route('training.materials.draft', $catalog) }}";
