...
<head>
    ...
    <style>
        ...
        .nav-tabs-custom .nav-link:hover { background: var(--primary-light); color: var(--primary-dark); }
        .nav-tabs-custom .nav-link.active { background: var(--primary); color: white; }
        .nav-tabs-custom .nav-link i { font-size: 1rem; }
        ...
        .course-card.due-soon { border-left: 3px solid var(--orange); }
        .course-card.assessment { border-left: 3px solid var(--blue); }
        .course-card.grant { border-left: 3px solid var(--orange); }

        .course-title { font-size: 0.95rem; font-weight: 700; color: var(--dark); margin-bottom: 0.5rem; line-height: 1.4; }
        .course-desc { font-size: 0.78rem; color: var(--secondary); margin-bottom: 0.75rem; line-height: 1.55; }
        .course-meta { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; font-size: 0.72rem; color: var(--secondary); }
        .course-meta i { font-size: 0.9rem; color: var(--secondary); }
        ...
        .badge-primary { background: var(--blue-light); color: #1d4ed8; }
        .badge-difficulty { font-size: 0.6rem; padding: 0.2rem 0.45rem; }
        ...
        .progress-mini .progress-bar { background: var(--primary); border-radius: 2px; }
        .progress-text { font-size: 0.68rem; color: var(--secondary); margin-top: 0.25rem; }
        ...
        .btn-view.assessment { background: var(--blue); }
        .btn-view.assessment:hover { background: #2563eb; }
        .btn-view.grant { background: var(--orange); }
        .btn-view.grant:hover { background: #d97706; }
        ...
        .btn-clear-filter { font-size: 0.75rem; padding: 0.55rem 1rem; border-radius: 10px; }
        ...
        .course-detail-title { font-size: 1.25rem; font-weight: 700; color: var(--primary-dark); margin-bottom: 0.5rem; }
        .course-detail-desc { font-size: 0.85rem; color: var(--secondary); margin-bottom: 0.75rem; }
        .course-detail-meta { display: flex; gap: 1.5rem; font-size: 0.75rem; color: var(--secondary); flex-wrap: wrap; }
        .btn-back-courses {
            font-size: 0.8rem; padding: 0.5rem 1rem; border-radius: 10px; border: 1px solid var(--primary); color: var(--primary); background: transparent;
        }
        .btn-back-courses:hover { background: var(--primary-light); color: var(--primary-dark); }

        .lessons-card, .lesson-content-card, .course-info-card, .material-card {
            background: white;
            border-radius: 14px;
            box-shadow: var(--card-shadow);
            border: 1px solid rgba(0,0,0,0.04);
        }
        .lessons-card { overflow: hidden; }
        .lessons-header {
            background: linear-gradient(90deg, var(--primary), #16a34a);
            color: white;
        ...
        .lesson-item.active { background: var(--primary-light); border-left: 3px solid var(--primary); }
        .lesson-number {
            width: 24px; height: 24px; background: var(--primary); color: white; border-radius: 7px; display: flex; align-items: center; justify-content: center; font-size: 0.7rem; font-weight: 700;
        }
        .lesson-title { font-size: 0.82rem; font-weight: 600; color: var(--dark); margin-bottom: 0; }
        .lesson-subtitle { font-size: 0.65rem; color: var(--secondary); }

        .lesson-content-body { padding: 1.25rem; }
        .lesson-content-header {
            display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #f1f5f9;
        }
        .lesson-content-title { font-size: 1.05rem; font-weight: 700; color: var(--primary-dark); margin: 0; }
        .lesson-text { font-size: 0.92rem; line-height: 1.75; color: var(--dark); }
        .lesson-text h1, .lesson-text h2, .lesson-text h3, .lesson-text h4, .lesson-text h5, .lesson-text h6 {
            color: var(--primary-dark); margin-top: 1.25rem; margin-bottom: 0.65rem;
        }
        .lesson-nav {
            display: flex; justify-content: space-between; gap: 0.75rem; margin-top: 1.25rem; padding-top: 1rem; border-top: 1px solid #f1f5f9;
        }
        .btn-lesson-nav { font-size: 0.75rem; padding: 0.5rem 1rem; border-radius: 10px; }

        .modal-content { border-radius: 16px; border: none; }
        .modal-header { border-radius: 16px 16px 0 0; padding: 1rem 1.25rem; }
        .modal-header.bg-warning { background: linear-gradient(135deg, var(--orange) 0%, #d97706 100%) !important; color: white; }
        .modal-header .btn-close { filter: brightness(0) invert(1); }
        .modal-title { font-size: 1rem; font-weight: 700; }
        .modal-body { padding: 1.25rem; }
        .modal-footer { padding: 1rem 1.25rem; border-top: 1px solid #f1f5f9; }

        .course-info-card { background: #f8fafc; }
        .course-info-header { padding: 0.85rem 1rem; border-bottom: 1px solid #e2e8f0; font-size: 0.85rem; font-weight: 700; }
        .course-info-body { padding: 1rem; }
        .course-info-item { margin-bottom: 1rem; }
        .course-info-item:last-child { margin-bottom: 0; }
        .course-info-label { font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.5px; color: var(--secondary); margin-bottom: 0.25rem; }
        .course-info-value { font-size: 0.85rem; font-weight: 600; color: var(--dark); }

        .material-card { padding: 1rem; margin-bottom: 0.75rem; }
        .material-card:last-child { margin-bottom: 0; }
        .material-title { font-size: 0.86rem; font-weight: 700; color: var(--dark); margin-bottom: 0.5rem; }
        .material-desc { font-size: 0.75rem; color: var(--secondary); margin-bottom: 0.75rem; }
        .material-badges { display: flex; flex-wrap: wrap; gap: 0.35rem; }
        .material-badge { font-size: 0.6rem; padding: 0.2rem 0.5rem; border-radius: 4px; }

        .main-content-shell { max-width: 1200px; }
...
<body>
    <div class="app-shell">
        ...
        <main class="main">
            ...
            <div class="main-content-shell mx-auto">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="course-card {{ $training['is_due_soon'] ? 'due-soon' : '' }}"
                                                ...
                                                <div class="card-body">
                                                    @if($training['is_due_soon'] || $training['time_until_due'] === 'Overdue')
                                                        <div class="mb-2">
                                                            @if($training['time_until_due'] === 'Overdue')
                                                                <span class="badge-status badge-overdue"><i class='bx bx-error-circle me-1'></i>Overdue</span>
                                                            @else
                                                                <span class="badge-status badge-due"><i class='bx bx-time me-1'></i>
                                                    ...
                                                    <div class="course-meta"><i class='bx bx-category'></i><span>{{ $training['category'] }}</span></div>
                                                    <div class="course-meta"><i class='bx bx-calendar'></i><span>Due: {{ $training['due_date'] ? \Carbon\Carbon::parse($training['due_date'])->format('M d, Y') : 'No due date' }}</span></div>

                                                    @if($training['progress'] > 0)
                                                        <div class="progress-mini"><div class="progress-bar" style="width: {{ $training['progress'] }}%"></div></div>
                                                        <div class="progress-text">{{ $training['progress'] }}% Complete</div>
                                                    @endif

                                                    <span class="btn-view"><i class='bx bx-play-circle'></i>View Lesson</span>
                                                </div>
                                            </div>
                                        </div>
                                    @empty
                            ...
                            <div id="course-detail-view" style="display: none;">
                                <div class="course-detail-header">
                                    <div class="d-flex justify-content-between align-items-start gap-3">
                                        ...
                                        <button class="btn-back-courses" onclick="backToCourses()"><i class='bx bx-arrow-back me-1'></i>Back</button>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="lessons-card">
                                            <div class="lessons-header"><i class='bx bx-list-ul me-2'></i>Course Lessons</div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="course-card assessment">
                                                <div class="card-body">
                                                    ...
                                                    <div class="course-meta"><i class='bx bx-repeat'></i><span>Attempts: {{ $assessment['attempts_used'] }}/{{ $assessment['max_attempts'] }}</span></div>
                                                    <div class="course-meta"><i class='bx bx-badge-check'></i><span>Status: {{ ucfirst($assessment['status']) }}</span></div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-warning btn-sm" id="requestCourseBtn"><i class='bx bx-plus-circle me-1'></i>Request Course</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="course-card grant">
                            <div class="card-body">
                                ...
                                <div class="course-meta"><i class='bx bx-category'></i><span>${course.category || 'Uncategorized'}</span></div>
                                <div class="course-meta"><i class='bx bx-time'></i><span>${course.duration || 'Self-paced'}</span></div>
                                <div class="course-meta"><i class='bx bx-medal'></i><span class="badge badge-difficulty bg-${difficultyColor}">${course.difficulty_level || 'N/A'}</span></div>
        ...
        function filterCourses() {
            ...
            filteredCourses = availableCourses.filter(course => {
                const matchesSearch = !searchTerm || course.title.toLowerCase().includes(searchTerm) || (course.description && course.description.toLowerCase().includes(searchTerm));
        ...
        function viewCourseDetails(courseId) {
            ...
            document.getElementById('courseDetailsInfo').innerHTML = `
                <div class="course-info-item"><div class="course-info-label">Category</div><div class="course-info-value">${course.category || 'General Training'}</div></div>
                <div class="course-info-item"><div class="course-info-label">Difficulty</div><div class="course-info-value">${course.difficulty_level || 'Not specified'}</div></div>
                <div class="course-info-item"><div class="course-info-label">Duration</div><div class="course-info-value">${course.duration || 'Self-paced'}</div></div>
                <div class="course-info-item"><div class="course-info-label">Objectives</div><div class="course-info-value" style="font-size: 0.75rem; font-weight: 400;">${course.learning_objectives || 'Develop skills in this area.'}</div></div>
            `;
        ...
        function displayTrainingMaterials(materials) {
            let html = `
                <div class="mb-3">
                    <h6 style="font-size: 0.9rem; font-weight: 700; color: var(--blue);">Course Content</h6>
            ...
            materials.forEach((material, index) => {
                html += `
                    <div class="material-card">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h6 class="material-title"><span class="badge bg-primary me-2" style="font-size: 0.65rem;">${index + 1}</span>${material.lesson_title}</h6>
