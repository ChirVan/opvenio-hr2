...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('assessment_results', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('assignment_id'); // Links to assessment_assignments in learning_management
            $table->string('employee_id'); // Employee ID from API
            $table->unsignedBigInteger('quiz_id'); // Links to quizzes table in learning_management
